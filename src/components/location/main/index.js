...
const LocationMain = ({ data }) => (
	<section className="location" id="location">
		<div className="container">
            ...
            <p>You'll be able to find accommodations in nearby Turtle Bay Resort or Villas. <strong>If you plan on staying in Waikiki, we will provide a shuttle to and from the wedding venue. Shuttle departs at 2:00pm from Hyatt Regency Waikiki Beach Resort And Spa. It will depart at 10:00pm from Waimea Valley for the return trip.</strong></p>
					</div>
