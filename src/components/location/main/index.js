...
const LocationMain = ({ data }) => (
	<section className="location" id="location">
		<div className="container">
            ...
            <p>You'll be able to find accommodations in nearby Turtle Bay Resort or Villas. If you plan on staying in Waikiki, the drive will take over 1 hour with Friday traffic.</p>
					</div>
